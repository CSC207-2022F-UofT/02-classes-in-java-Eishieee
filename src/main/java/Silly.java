...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object
     * This constructor takes two strings as an argument
     * @param s1 a string for the first part of Silly instance's name.
     * @param s2 a string for the second part of Silly instance's name.
     */
